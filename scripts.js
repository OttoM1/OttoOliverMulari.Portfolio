...
document.addEventListener('DOMContentLoaded', () => {
    ...
    Object.assign(storyModeButton.style, { 
        position: 'fixed', top: '15px', right: '15px',
        flexDirection: 'column',
        padding: '12px 20px', backgroundColor: '#cf6223',
        color: 'white', border: 'none', cursor: 'pointer',
        fontSize: '36.4px', zIndex: '1000', borderRadius: '19px',
        transition: 'background 0.3s ease'
    });
    storyModeButton.addEventListener('mouseover', () => storyModeButton.style.backgroundColor = 'cf6223');
    storyModeButton.addEventListener('mouseout', () => storyModeButton.style.backgroundColor = 'cf6223');
    document.body.appendChild(storyModeButton);
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function draw() {
        ctx.fillStyle = "rgba(253, 248, 221, 0.16)";
        ctx.fillRect(0, 0, canvas.width, canvas.height);
